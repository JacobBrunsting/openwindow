angular.module('openwindow').service('post_creator', [function () {
    ...
    this.createPost = function (id, title, body, upvoted, downvoted, posterId,
        ...
        post.getTitle = function () {
            return post.title;
        }
        post.getBody = function () {
            return post.body;
        }
        post.isUpvoted = function () {
            return post.upvoted;
        }
        post.isDownvoted = function () {
            return post.downvoted;
        }
        post.getPosterId = function () {
            return post.posterId;
        }
        post.getPostTime = function () {
            return post.postTime;
        }
        post.getSecondsToShowFor = function () {
            return post.secondsToShowFor;
        }
        post.getComments = function () {
            return post.comments;
        }
        post.getMainDatabaseAddr = function () {
            return post.mainDatabaseAddr;
        }
        post.getBackupDatabaseAddr = function () {
            return post.backupDatabaseAddr;
        }

        post.setIsUpvoted = function (val) {
            post.upvoted = val;
        }
        post.setIsDownvoted = function (val) {
            post.downvoted = val;
        }
        post.setPostTime = function (val) {
            post.postTime = val;
        }
        post.setSecondsToShowFor = function (val) {
            post.secondsToShowFor = val;
        }
        post.setComments = function (val) {
            post.comments = val;
        }
